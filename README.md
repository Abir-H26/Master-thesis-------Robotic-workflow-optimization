...
<h3>2.3 Statistical & Machine‑Learning Modeling</h3>
...
<ul>
  <li><strong>Designed the experimental plan</strong> using fractional factorial DoE.</li>
  <li><strong>Built linear regression models</strong> for effect estimation and interaction analysis.</li>
  <li><strong>Implemented Support Vector Regression (SVR)</strong> for nonlinear predictive modeling.</li>
...
<h3>3.3 Design of Experiments (DoE)</h3>
